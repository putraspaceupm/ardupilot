...
public:
    ...
    enum {
		...
		//added for pump activation for stan's FYP 13/4/2016
		/* k_param_pump_act1_altitude,
		k_param_pump_act2_altitude, */
...
/* 	//pump activation mechanism
	AP_Int8 pump_act1_altitude;	
	AP_Int8 pump_act2_altitude;	  */
