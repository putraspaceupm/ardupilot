...
void Plane::updateHABmission()
{
	...
	//2. trigger pump for air sampling experiment (currently not in use)
	//pump_trigger();
	
	//3. Trigger SMA wire experiment (currently not in used)
	//sma_activation();
	
	//4. Release stratocacher module (used in MRSM competition)
	update_stratocacherRelease();

	//5. Release payload at max reached altitude
	update_releaseatmax();
}
...
//void Plane::
void Plane::update_pump_trigger()
{		
	   //////////////////////////////////////////////////////////////////////////////////////////////////////
...
void Plane::update_sma_activation()
{      
	 ///////////////////////////////////////////////////////////////////////////////////////////////////////////
